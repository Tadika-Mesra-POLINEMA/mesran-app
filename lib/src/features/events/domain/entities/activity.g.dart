...
extension GetActivityCollection on Isar {
  IsarCollection<Activity> get activities => this.collection();
}
...
const ActivitySchema = CollectionSchema(
  ...
  properties: {
    r'activity_end': PropertySchema(
      id: 0,
      name: r'activity_end',
      type: IsarType.dateTime,
    ),
    r'activity_start': PropertySchema(
      id: 1,
      name: r'activity_start',
      type: IsarType.dateTime,
    ),
...
void _activitySerialize(
  ...
  writer.writeDateTime(offsets[0], object.activityEnd);
  writer.writeDateTime(offsets[1], object.activityStart);
...
Activity _activityDeserialize(
  ...
  object.activityEnd = reader.readDateTime(offsets[0]);
  object.activityStart = reader.readDateTime(offsets[1]);
...
extension ActivityQueryFilter
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityEndEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'activity_end',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityEndLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityEndBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityStartEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'activity_start',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityStartLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> activityStartBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ActivityQuerySortBy on QueryBuilder<Activity, Activity, QSortBy> {
  QueryBuilder<Activity, Activity, QAfterSortBy> sortByActivityEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_end', Sort.asc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> sortByActivityEndDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_end', Sort.desc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> sortByActivityStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_start', Sort.asc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> sortByActivityStartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_start', Sort.desc);
    });
  }
...
extension ActivityQuerySortThenBy
  ...
  QueryBuilder<Activity, Activity, QAfterSortBy> thenByActivityEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_end', Sort.asc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> thenByActivityEndDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_end', Sort.desc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> thenByActivityStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_start', Sort.asc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy> thenByActivityStartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'activity_start', Sort.desc);
    });
  }
...
extension ActivityQueryWhereDistinct
  ...
  QueryBuilder<Activity, Activity, QDistinct> distinctByActivityEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'activity_end');
    });
  }

  QueryBuilder<Activity, Activity, QDistinct> distinctByActivityStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'activity_start');
    });
  }
...
extension ActivityQueryProperty
  ...
  QueryBuilder<Activity, DateTime, QQueryOperations> activityEndProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'activity_end');
    });
  }

  QueryBuilder<Activity, DateTime, QQueryOperations> activityStartProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'activity_start');
    });
  }
